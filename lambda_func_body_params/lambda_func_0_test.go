...
var (
	SERVICE_URL = "https://3vefaztvjh.execute-api.us-east-1.amazonaws.com/lambda_func_body_params"
	ACCESS_KEY  = ""
	SECRET_KEY  = ""
)
...
func Test_without_aws_signature(t *testing.T) {
	...
	t.Run("POST_request", func(t *testing.T) {
		...
		resp, err := http.Post(SERVICE_URL, "application/json", bytes.NewBuffer(personJSON))
